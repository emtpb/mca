...
def test_check_signals():
    validator.check_type_signal(data_types.Signal(None, None,
                                                  None, None, None))
...
def test_check_intervals():
    a = data_types.Signal(None, 0, 10, 0.1, None)
    b = data_types.Signal(None, 1, 5, 0.1, None)
    c = data_types.Signal(None, 0.01, 5, 0.1, None)
    d = data_types.Signal(None, 0, 10, 0.05, None)
