...
test_signal0 = data_types.Signal(0, 5, 0.1, np.full((5,), 1))
test_signal1 = data_types.Signal(-2, 10, 0.1, np.full((10,), 1))
test_signal2 = data_types.Signal(-1, 15, 0.1, np.full((15,), 1))

expected_ordinate0 = np.full((25,), 1)
expected_ordinate0[10:20] = np.zeros(10)
expected_signal0 = data_types.Signal(-2, 25, 0.1, expected_ordinate0)

expected_ordinate1 = np.full((15,), 1)
expected_ordinate1[10:15] = np.full((5,), 2)
expected_signal1 = data_types.Signal(-1, 15, 0.1, expected_ordinate1)
